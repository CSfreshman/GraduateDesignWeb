        ...
        <div class="cont" v-if="role > 1">
          ...
          <div>
            ...
            <el-table :data="tableData.slice((currentPage -1) * pageSize, currentPage*pageSize)" style="width: 100%">
              ...
              <el-table-column prop="topicName" label="选题名称" width="120"></el-table-column>
              <el-table-column prop="date" label="答辩日期" width="160"></el-table-column>
              <el-table-column prop="location" label="答辩地点" width="130"></el-table-column>
              <el-table-column prop="record" label="答辩记录" width="130"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.service.get('/defense/getAll')
          .then(res => {
            console.log(res)
