...
<!--    </el-dialog>-->
    ...
    <el-table :data="tableData.slice((currentPage -1) * pageSize, currentPage*pageSize)" style="width: 100%">
      <el-table-column prop="teacherNo" label="工号" width="220"></el-table-column>
      <el-table-column prop="teacherName" label="姓名" width="220"></el-table-column>
      <el-table-column prop="typeDesc" label="指导选题类型" width="220"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    //获取所有数据
    getData(){
      console.log("请求所有老师信息")
      this.service.get('/teacherInfo/getAll',this.teacher)
          .then(res=>{
            console.log(res)
